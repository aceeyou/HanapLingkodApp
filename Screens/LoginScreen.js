...
import { Text, View, SafeAreaView, Image, TouchableOpacity, StatusBar, StyleSheet } from 'react-native';
...
function LoginScreen({navigation}) {
    ...
    return (
      <SafeAreaView style={{ flex: 1, marginTop: StatusBar.currentHeight, paddingHorizontal: 30}}>
        <View style={{flex: 1, flexDirection: 'column', alignItems: 'center', paddingVertical: 50}}>
          <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginBottom: 20}}>
            <Image source={require('../assets/bg.png')} style={{width: 120, height: 120, borderRadius: 60}}/>
            <Text style={{fontSize: 20, fontWeight: '700', marginTop: 10, marginBottom: 6}}>HanapLingkod</Text>
          ...
          <View style={{width: '100%', paddingHorizontal: '5%', paddingVertical: 80}}>
            <View style={{marginBottom: 20}}>
              <FloatingLabelInput
                ...
                customLabelStyles={{colorBlurred: 'black', colorFocused: 'black', fontSizeFocused: 12,}}
          ...
          <View style={{width: '100%', alignItems: 'center', paddingTop: 80}}>
            ...
            <TouchableOpacity 
              ...
              >
                <Text style={{color: 'white', textAlign:'center', fontWeight: '700'}}>Create an Account</Text>
            </TouchableOpacity>
          </View>
        </View>
      </SafeAreaView>
